...
Если загрузка медиа в панели 0.5.0 отвечала «kind and a named file are required», обновите панель до 0.5.1: браузерная форма не передавала поля файла. В 0.5.1 ошибка исправлена, а результат проверки версий и ревизия резервной копии видны в разделе «Обслуживание». Повторная Docker-установка той же ревизии больше не заменяет резервную копию идентичным бинарником.
